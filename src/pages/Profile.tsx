...
import { User, Save, Palette, Shirt, Heart } from "lucide-react";
...
const stylePreferences = [
  ...
  { id: "minimalist", label: "Minimalist Chic" },
  { id: "bold", label: "Bold & Trendy" },
  { id: "romantic", label: "Romantic & Feminine" },
];
const colorPalettes = [
  { id: "neutrals", label: "Warm Neutrals" },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-28 pb-20 container mx-auto px-6 max-w-2xl">
        <div className="mb-8">
          <h1 className="font-display text-4xl font-medium mb-2">Profile Settings</h1>
          <p className="text-muted-foreground">Customize your style preferences</p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-card rounded-xl p-6 border border-border/50">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="font-display text-xl font-medium">Basic Information</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                <Label>Email</Label>
                <Input value={user?.email || ""} disabled className="bg-accent/50" />
              </div>
              <div>
                <Label>Height</Label>
                <Input
          ...
          <div className="bg-card rounded-xl p-6 border border-border/50">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="font-display text-xl font-medium">Style Preferences</h2>
            </div>
            <div className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 mt-2">
                  {stylePreferences.map((style) => (
                    <button
                      key={style.id}
                      onClick={() => setProfile({ ...profile, style_preference: style.id })}
              ...
              <div>
                ...
                <Select value={profile.budget_range} onValueChange={(v) => setProfile({ ...profile, budget_range: v })}>
                  <SelectTrigger>
          ...
          <div className="flex gap-4">
            <Button variant="gold" onClick={saveProfile} disabled={saving} className="flex-1">
